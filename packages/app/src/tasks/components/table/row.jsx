...
const TaskRowPrimitive = ({ style, index, task, onSelectTask }) => {
  const match = /Starting at|No variation|Waiting for captcha|Duplicate order|Checking status|Checkout failed|Polling queue|Payment successful|Payment failed/i.exec(
    task.message,
  );
