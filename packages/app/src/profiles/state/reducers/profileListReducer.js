...
import { PROFILE_ACTIONS, SETTINGS_ACTIONS } from '../../../store/actions';
import { profileReducer } from './profileReducer';
import { Profiles, rates as RatesState } from '../initial';
import dsmlRates from '../../../constants/dsmlRates';

export default function profileListReducer(state = Profiles, action) {
