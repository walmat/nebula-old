...
export default async (slack, discord, payload) => {
  ...
  const hooks = [
    slack.build(success, type, checkoutUrl, product, price, store, order, profile, size, image),
    discord.build(success, type, checkoutUrl, product, price, store, order, profile, size, image),
  ];
