...
describe('profile list reducer', () => {
  ...
  describe('should handle add', () => {
    test('when valid action is passed', () => {
      const actual = profileListReducer(
  ...
  describe('should handle remove', () => {
    ...
    test('when id is null', () => {
      ...
      const actual = profileListReducer(
        start,
        {
          type: PROFILE_ACTIONS.REMOVE, id: null,
        },
      );
    ...
    test('when given id is not in the state', () => {
      ...
      const actual = profileListReducer(
        start,
        {
          type: PROFILE_ACTIONS.REMOVE, id: 3,
        },
      );
      expect(actual).toEqual(start);
    });
  ...
  describe('should handle edit', () => {
    test('when valid action is passed', () => {
      ...
      const actual = profileListReducer(
        start,
        {
          type: PROFILE_ACTIONS.EDIT, id: 1, field: PROFILE_FIELDS.EDIT_NAME, value: 'changed',
        },
      );
      expect(actual).toEqual(expected);
    });
    ...
    test('when id is null', () => {
      ...
      const actual = profileListReducer(
        start,
        {
          type: PROFILE_ACTIONS.EDIT, id: null, field: PROFILE_FIELDS.EDIT_NAME, value: 'changed',
        },
      );
      expect(actual).toEqual(start);
    });
    ...
    test('when id is not given', () => {
      ...
      const actual = profileListReducer(
        start,
        {
          type: PROFILE_ACTIONS.EDIT, field: PROFILE_FIELDS.EDIT_NAME, value: 'changed',
        },
      );
      expect(actual).toEqual(start);
    });
    ...
    test('when given id is not in the current state', () => {
      ...
      const actual = profileListReducer(
        start,
        {
          type: PROFILE_ACTIONS.EDIT, id: 3, field: PROFILE_FIELDS.EDIT_NAME, value: 'changed',
        },
      );
      expect(actual).toEqual(start);
    });
