...
const s = [
  { value: 'https://kith.com', label: 'Kith', supported: true },
  ...
  { value: 'https://yeezysupply.com', label: 'Yeezy Supply', supported: true },
  { value: 'https://www.funko-shop.com', label: 'Funko Shop', supported: true },
  ...
  { value: 'https://thedarksideinitiative.com', label: 'Dark Side Initiative', supported: true },
  ...
  { value: 'https://burnrubbersneakers.com', label: 'Burn Rubber', supported: true },
  ...
  { value: 'https://offthehook.ca', label: 'Off the Hook', supported: true },
  ...
  { value: 'https://rsvpgallery.com', label: 'RSVP Gallery', supported: true },
  { value: 'https://shoegallerymiami.com', label: 'Shoe Gallery' },
  { value: 'https://shop.bdgastore.com', label: 'Bodega', supported: true },
  { value: 'https://shop.exclucitylife.com', label: 'Exclucity' },
  { value: 'https://shop.extrabutterny.com', label: 'Extra Butter' },
  { value: 'https://shop.havenshop.ca', label: 'Haven CA', supported: true },
  { value: 'https://shop.justintimberlake.com', label: 'Justin Timberlake' },
  { value: 'https://shop.travisscott.com', label: 'Travis Scott', supported: true },
  { value: 'https://shop.undefeated.com', label: 'Undefeated', supported: true },
  { value: 'https://shopnicekicks.com', label: 'Shop Nice Kicks', supported: true },
  ...
  { value: 'https://wishatl.com', label: 'Wish Atlanta', supported: true },
  { value: 'https://www.abovethecloudsstore.com', label: 'Above the Cloud' },
  { value: 'https://www.addictmiami.com', label: 'Addict' },
  { value: 'https://amongstfew.com', label: 'Amongst Few', supported: true },
  ...
  { value: 'https://deadstock.ca', label: 'Livestock', supported: true },
  ...
  { value: 'https://minishopmadrid.com', label: 'Mini Shop Madrid', supported: true },
  ...
  { value: 'https://eflash-sg.doverstreetmarket.com', label: 'DSM SG', supported: true },
  { value: 'https://eflash-jp.doverstreetmarket.com', label: 'DSM JP', supported: true },
  { value: 'https://eflash-us.doverstreetmarket.com', label: 'DSM US', supported: true },
  { value: 'https://eflash.doverstreetmarket.com', label: 'DSM UK', supported: true },
