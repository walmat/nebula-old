...
async function handleDirectMessage(message) {
    if (message.content.toLowerCase().startsWith('!bind ')) {
        // attempt to bind user
        await bindUser(message);
    } else {
        message.channel.send('Please send the following message to register: "!bind <registation key>"');
    }
}
...
client.on('message', async (message) => {
    ...
    The message must contain !bind <registration key>*/
    if (message.guild === null && !message.author.bot) {
